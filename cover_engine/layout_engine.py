...
class CoverLayoutEngine:
    ...
    def add_text(self, title, description, author,
        ...
        Uses Pango for professional text rendering.
        """
        ...
        title_img = render_text(title, font_family, font_size=96,
        ...
        desc_img = render_text(description, font_family, font_size=48,
        ...
        spine_img = render_rotated_text(spine_text, font_family,
                                        font_size=64, color=title_color, box_size=spine_box)
