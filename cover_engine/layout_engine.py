...
class CoverLayoutEngine:
    ...
    def add_text(self, title, description, author,
                 ...
                 letter_spacing=0, body_font="DejaVu Serif"):
        ...
        title_img = render_text(title, font_family, title_font_size, title_color,
                                front_box, align="center", valign="middle",
                                bold=True, add_bg=add_bg,
    ...
    def _add_gradient_bar(self, box, opacity=200):
        x1, y1, x2, y2 = box
